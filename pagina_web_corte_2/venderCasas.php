    ...
    <div class="container">
        <form action="venderCasas.php" method="post">
            ...
            $form =
                '
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre" value=' . $_SESSION['nombre'] . ' disabled>
                    </div>
                    <div class="mb-3">
                        <label for="apellido" class="form-label">Apellido:</label>
                        <input type="text" class="form-control" id="apellido" value=' . $_SESSION['apellido'] . ' disabled>
                    </div>
                ';
            echo $form;
            ?>
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="numeroCuenta" name="numeroCuenta"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="localizacion" name="localizacion"
                    placeholder="Barrio la esmeralda">
            </div>

            <div class="mb-3">
                <label for="precio" class="form-label">Precio:</label>
                <input type="number" class="form-control" id="precio" name="precio" placeholder="$ 2'000.000">
            </div>
